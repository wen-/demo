			...
			var play = {
				...
				door2_in:function(box){
					...
					if(!$box_3d.children().hasClass(obj.view_class)){
						...
						$("."+obj.view_versa_class).attr("style",transformAll+': translate3d(0px, 0px, 0px) rotate3d(0, 1, 0, 0deg);height:'+h+'px;width:'+w+'px;position:absolute;z-index;100;left:0;top:0;background-color:transparent');
