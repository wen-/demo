...
$(document).on("pagecreate","#door1,#door2",function() {
//绑定单门左右滑动事件
    $(document).on({
...
$(document).on("pagecreate","#door3",function() {
//地毯
...
$(document).on("pagecreate","#door8",function() {
//8关指纹
...
$(document).on("pagecreate","#door9",function() {
//9关填字
