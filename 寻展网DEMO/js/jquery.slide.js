...
ScrollPic.prototype = {
    ...
    initialize: function() {
        ...
        this.scDiv.style[this.upright ? 'height': 'width'] = this.frameWidth*this.frameWidth_1 + "px";
        ...
        i,
        tempObj;//---pages为页数，不要给对象设置clearfix，否则在IE6下识别offsetWidth/offsetHeight错误--32766-----
